...
RUN apt update && apt install --no-install-recommends -y wget git automake libtool make cmake gcc g++ pkg-config libmagic-dev curl \
    tar unzip libglib2.0-0 libssl-dev libfuzzy-dev software-properties-common python3-software-properties build-essential python3.10 python3.10-dev openssh-client
